...
% %% $m[PrxAcctHolder==$1<praxis_id::account holder//Bank//%(value)s::>1$]m$
% %% $m[PrxBankName==$1<praxis_id::bank name//Bank//%(value)s::60>1$]m$
% %% $m[PrxIBAN==$1<praxis_id::IBAN//Bank//%(value)s::30>1$]m$
% %% $m[PrxBIC==$1<praxis_id::BIC//Bank//%(value)s::30>1$]m$
% https://duckduckgo.com/?q=BIC+DEUTDEFFXXX&ia=web
% %% $m[PrxBIChref==$2<if_not_empty::$m[PrxBIC]m$|--2--|\href{https://duckduckgo.com/?q=BIC+%s&ia=web}{$m[PrxBIC]m$}|--2--|{}::>2$]m$
...
\setkomavar{firstfoot}{%
	...
	\parbox[t]{\textwidth}{%
		...
		\hfill
		\begin{tabular}[t]{ll}%
			\multicolumn{2}{l}{$m[PrxBankName]m$}\\
			BIC         & { $m[PrxBIChref]m$ }\\
			IBAN        & $m[PrxIBAN]m$\\
			Acct Holder & $m[PrxAcctHolder]m$
		\end{tabular}%
	}\newline
	{%
		\tiny{}%
		GNUmed $1<client_version::::>1$ (\href{https://www.gnumed.de}{www.gnumed.de})%
		\hfill{}%
		Template $1<form_name_long::::60>1$ v$1<form_version::::20>1$%
	}
}
