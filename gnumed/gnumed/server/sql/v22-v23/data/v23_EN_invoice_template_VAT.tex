...
% %% $m[PrxLogoIncludeGfxOrHREF==$2<if_not_empty::$m[PrxCommW]m$|--2--|\href{http://%s}{$m[PrxLogoInclude]m$}|--2--|$m[PrxLogoInclude]m$::>2$]m$
\setkomavar{fromlogo}{%
	$3<if_not_empty::$m[PrxLogoPngName]m$|--3--|$m[PrxLogoIncludeGfxOrHREF]m$|--3--|$2<if_not_empty::$m[PrxIBAN]m$|--2--|$m[PrxScan2PayHREF]m$ % no praxis logo available|--2--|% no praxis logo available::>2$::>3$%
}
